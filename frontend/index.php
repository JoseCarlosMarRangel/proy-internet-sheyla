                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <div class="departamentos">
                                    ...
                                    <center>  
                                    <a href="../frontend/administracion_index.html"><button class = "btn button-">Entrar</button></a>
                                    </center>                                        
                                </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                <div class="departamentos">
                                    ...
                                    <h1 >Comercial</h1>
                                    <center>  
                                    <a href="../frontend/comercial_index.html"><button class = "btn button-">Entrar</button></a>
                                    </center>                                        
                                </div>
                                </div>
                              <div class="col-md-4">
                                <div class="departamentos">
                                    ...
                                    <center>  
                                    <a href="../frontend/direccion_index.html"><button class = "btn button-">Entrar</button></a>
                                    </center>                                        
                                </div>
                              </div>
                              </div><!--.row-->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="departamentos">
                                        ...
                                        <h1 >Legal</h1>
                                        <center>  
                                        <a href="../frontend/legal_index.html"><button class = "btn button-">Entrar</button></a>
                                        </center>                                        
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="departamentos">
                                        ...
                                        <h1 >Producción</h1>
                                        <center>  
                                        <a href="../frontend/produccion_index.html"><button class = "btn button-">Entrar</button></a>
                                        </center>                                        
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="departamentos">
                                        ...
                                        <center>  
                                        <a href="../frontend/rrhh_index.html"><button class = "btn button-">Entrar</button></a>
                                        </center>                                        
                                    </div>
                                </div>
                                </div><!--.row-->
