            ...
            <div class="col-md-12">
              <div id="Carousel" class="carousel slide">
                <ol class="carousel-indicators">
                  ...
                  ?>
                    <li data-target="#Carousel" data-slide-to="<?php echo $slide;  ?>" <?php if ($slide == 0){ echo "class='active'"; } ?> ></li>
                  <?php } ?>
                </ol>
                <br><br>
                <!-- Carousel items -->
                ...
                <div class="carousel-inner">
                  ...
                  ?>
                    ...
                    <div class="item<?php if ($slide == 0){ echo ' active'; } ?>">
                      <div class="row">
                        <?php 
                        ...
                        ?>
                              <div class="col-md-4">
                                <embed src="<?php echo $row['Directorio']; ?>" type="application/pdf" width="220px" height="300px">                                  
                                  ...
                                  <input class="btn button-" type="submit" name="rechazar"  value="Rechazar"></form>
                              </div>
                        <?php
            ...
            <div class="col-md-12">
              <div id="Carousel2" class="carousel slide">
                <ol class="carousel-indicators">
                  ...
                  ?>
                    <li data-target="#Carouse2" data-slide-to="<?php echo $slide2;  ?>" <?php if ($slide2 == 0){ echo "class='active'"; } ?> ></li>
                  <?php } ?>
                </ol>
                <br><br>
                <!-- Carousel items -->
                ...
                <div class="carousel-inner">
                  ...
                  ?>
                    ...
                    <div class="item<?php if ($slide2 == 0){ echo ' active'; } ?>">
                      <div class="row">
                        <?php 
            ...
            <div class="col-md-12">
              <div id="Carousel3" class="carousel slide">
                <ol class="carousel-indicators">
                  ...
                  ?>
                    <li data-target="#Carouse3" data-slide-to="<?php echo $slide3;  ?>" <?php if ($slide3 == 0){ echo "class='active'"; } ?> ></li>
                  <?php } ?>
                </ol>
                <br><br>
                <!-- Carousel items -->
                ...
                <div class="carousel-inner">
                  ...
                  ?>
                    ...
                    <div class="item<?php if ($slide3 == 0){ echo ' active'; } ?>">
                      <div class="row">
                        <?php 
                        ...
                        ?>
                              <div class="col-md-4">
                                <embed src="<?php echo $row3['Directorio']; ?>" type="application/pdf" width="220px" height="300px">                                  
                                  ...
                                  <input class="btn button-" type="submit" name="aprobar"  value="Aceptar"></form>
                              </div>
                        <?php
